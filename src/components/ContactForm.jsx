      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
          ...
          <Button 
            ...
            className="w-full h-12 md:h-14 text-base md:text-lg bg-blue-600 hover:bg-blue-700 text-white rounded-xl shadow-lg shadow-blue-600/20 flex items-center justify-center"
          >
            {status === 'loading' ? (
              <>Sending... <Loader2 size={20} className="ml-2 animate-spin" aria-hidden="true" /></>
            ) : (
