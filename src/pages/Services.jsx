...
const Services = () => {
  ...
  return (
    <div className="overflow-x-hidden bg-slate-50">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
          <motion.div initial="hidden" animate="visible" variants={fadeInUp}>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white tracking-tight mb-8 leading-tight">
              Everything Your Business <span className="bg-clip-text text-transparent bg-gradient-to-br from-cyan-400 to-blue-600">Needs Online</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
              From websites to SEO, social media to IT support — we handle the digital side so you can focus on your business.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          >
            ...
            <input 
              type="text" 
              placeholder="Search services (e.g. SEO, Website, Marketing)..." 
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="w-full pl-14 pr-6 py-4 rounded-2xl border border-slate-200 bg-white text-base focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent shadow-lg shadow-slate-200/50 transition-all placeholder:text-slate-400 text-slate-900"
            />
          </motion.div>
                ...
                return (
                  ...
                  >
                    <Link to={`/services/${service.id}`} className="block h-full">
                      <div className="bg-white rounded-[2rem] p-7 border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-blue-500/8 hover:-translate-y-2 transition-all duration-300 h-full flex flex-col group">
                        {/* Icon */}
                        ...
                        {/* Title */}
                        <h3 className="text-lg font-bold text-slate-900 mb-2 tracking-tight">{service.title}</h3>
      ...
      {/* Bottom CTA */}
      <section className="py-20 md:py-28 bg-white text-center border-t border-slate-100">
        <div className="container mx-auto px-6 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-6 tracking-tight">Not sure what you need?</h2>
          <p className="text-lg md:text-xl text-slate-700 mb-8 leading-relaxed">
            Take our 60-second quiz or try the cost estimator to get a personalised recommendation.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/quiz" className="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 text-white rounded-full text-lg font-bold hover:bg-blue-700 transition-all hover:-translate-y-1 shadow-xl shadow-blue-600/20">
              Take the Quiz <ArrowRight size={20} />
            </Link>
            <Link to="/estimator" className="inline-flex items-center gap-2 px-8 py-4 border-2 border-slate-200 text-slate-700 rounded-full text-lg font-bold hover:border-blue-300 hover:bg-blue-50 transition-all">
